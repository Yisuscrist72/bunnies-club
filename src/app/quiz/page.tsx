  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-4 py-24 overflow-x-hidden pt-32">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        {/* Lado Izquierdo */}
        <div className="absolute top-[20%] left-[5%] text-4xl opacity-40">💖</div>
        <div className="absolute top-[35%] left-[15%] text-5xl opacity-40">👽</div>
        <div className="absolute bottom-[25%] left-[8%] text-3xl opacity-40">⭐</div>
        
        {/* Lado Derecho */}
        <div className="absolute top-[15%] right-[8%] text-4xl opacity-40 animate-pulse">✨</div>
        <div className="absolute top-[40%] right-[12%] text-5xl opacity-40">👽</div>
        <div className="absolute bottom-[30%] right-[5%] text-3xl opacity-40">💖</div>
        <div className="absolute top-[60%] right-[5%] text-4xl opacity-40">👽</div>
        ...
        >
           <Image src="/images/bunny-logo.avif" alt="Bunny" width={120} height={120} className="border-4 border-white rounded-3xl" />
        </motion.div>
