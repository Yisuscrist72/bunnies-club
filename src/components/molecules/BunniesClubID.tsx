    ...
    return (
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(#FF69B4 2.5px, transparent 2.5px)",
          ...
          <div className="flex flex-col justify-between flex-1 py-1">
            <div>
              <Jersey
                ...
                size="32|40"
                className="text-black mb-2 truncate drop-shadow-[2px_2px_0px_rgba(255,105,180,0.3)]"
              />
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <SpaceText
                    text={profile.rank}
                    size="16|16"
                    className="text-v2k-pink-hot font-black uppercase leading-none"
                  />
                </div>
                <div className="flex items-center gap-3">
                  <SpaceText
        ...
        {/* Decorative Stickers */}
        <div className="absolute bottom-2 right-2 text-3xl opacity-20 rotate-12 pointer-events-none">
          ✨
        </div>
        <div className="absolute top-16 right-4 text-2xl opacity-10 -rotate-12 pointer-events-none">
          🎀
        </div>
      </div>
    );
