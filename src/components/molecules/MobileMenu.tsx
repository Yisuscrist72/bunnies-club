        ...
        >
          ...
          <div className="w-full bg-[#80c8f0] p-2 border-b-[3px] border-black flex justify-between items-center shadow-[0_2px_0_rgba(255,255,255,0.4)_inset]">
            <div className="flex items-center gap-2 ml-2">
              ...
              <Jersey tag="span" text="BUNNIES_MENU.EXE" size="12|12" className="text-black tracking-tighter font-bold" />
            </div>
            <motion.button 
            ...
            >
              <Jersey tag="span" text="X" size="14|14" className="font-bold text-black" />
            </motion.button>
          </div>
          ...
          <div className="p-8 flex flex-col items-center gap-6 bg-black/5 border-t-[2px] border-black/10 z-10">
            ...
            >
              <Jersey tag="span" text="ESPAÑOL / ENGLISH" size="16|16" className="text-black" />
            </motion.button>
          </div>

          {/* BARRA DE ESTADO */}
          <div className="w-full bg-[#BEE5FD] border-t-[3px] border-black px-4 py-1 flex justify-between items-center font-bold">
            <Jersey tag="span" text="SYSTEM READY" size="12|12" className="text-black" />
            <div className="flex gap-2 items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
              <Jersey tag="span" text="v1.0" size="12|12" className="text-black" />
            </div>
          </div>
        </motion.div>
      )}
