          ...
          >
            ...
            <div className="bg-[#D1C4E9] rounded-[30px] p-4 border-[3px] border-black shadow-[inset_4px_4px_0px_rgba(0,0,0,0.1)] flex flex-col gap-3 overflow-hidden relative">
              ...
              <div className="relative h-5 bg-white border-[2.5px] border-black rounded-full overflow-hidden mt-1 shadow-[2px_2px_0px_rgba(0,0,0,0.1)] z-10">
                <div
                  className="absolute top-0 left-0 h-full bg-[#FFB7CE] border-r-2 border-black"
            ...
            <div className="flex flex-col gap-4 px-1">
              <div className="flex justify-between items-center gap-3">
                <button
                  type="button"
                  onClick={playPrev}
                  className="flex-1 h-12 rounded-2xl bg-[#B2F2BB] border-[3px] border-black text-black shadow-[4px_4px_0px_#000] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all flex items-center justify-center"
                >
                ...
                <button
                  type="button"
                  onClick={togglePlay}
                  className="w-16 h-16 bg-[#FFB7CE] border-[4px] border-black rounded-full shadow-[5px_5px_0px_#000] flex items-center justify-center text-black active:translate-x-1 active:translate-y-1 active:shadow-none transition-all"
                >
                ...
                <div className="flex-1 flex flex-col items-center">
                  ...
                  <div className="flex gap-1">
                    {[20, 40, 60, 80, 100].map((v) => (
                      <div
                        key={`v-${v}`}
                        className={`w-3 h-2 rounded-sm border border-black ${volume >= v ? "bg-[#FFD1DC]" : "bg-gray-100"}`}
                      />
                    ))}
                  </div>
                </div>
