...
export default function MusicPlayer() {
	...
	const controlButtonClass =
		"w-11 h-9 md:w-12 md:h-10 bg-white border-[2px] border-black flex items-center justify-center shadow-[2px_2px_0px_#000] cursor-pointer active:shadow-none active:translate-x-[2px] active:translate-y-[2px] transition-all text-black";
	...
	return (
		<div className="flex flex-col items-center gap-3 w-full max-w-[280px] mx-auto">
			...
			<div className="flex gap-2">
				...
				<button type="button" className={controlButtonClass} onClick={togglePlay}>
