            ...
            >
              <div className="bg-v2k-accent border-b-4 border-black px-3 h-10 flex justify-between items-center">
                ...
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="w-6 h-6 bg-v2k-pink-light border-2 border-black flex items-center justify-center text-[10px] font-black hover:bg-v2k-pink-hot active:translate-y-0.5 active:translate-x-0.5 cursor-pointer"
                >
                  ✕
                </button>
              </div>
                  ...
                  {product.shops.map((shop, idx) => (
                    ...
                    >
                      ...
                      <div className="relative bg-white border-2 border-black p-3 flex justify-between items-center hover:-translate-y-1 hover:-translate-x-1 active:translate-x-0 active:translate-y-0 transition-all cursor-pointer">
                        <span className="font-space font-black text-xs text-black uppercase tracking-widest">
                          {shop.name}
                        </span>
                        <span className="font-black text-black text-lg group-hover/link:translate-x-1 group-hover/link:-translate-y-1 transition-transform">
                          ↗
                        </span>
                      </div>
                    </a>
